...
DeltaH_prod = 350000              # enthalpy produced by turbine [J/Kg]
...
# BOUDS FOR OPTIMIZATION VARIABLES
# stator.eta, rotor.eta, two.alpha, thr.beta
list_lb = [0,0,70,-70]
list_ub = [1,1,75,-60]
...
if design_tool_version == 'losses':
    ...
    etas = np.array([eta_stator_init, eta_rotor_init, alpha2_init, beta3_init])
    res = converge_efficiencies_limits(etas, stator, rotor, one, two, thr, gamma, cp, R, GR, psi, DeltaH_prod, RHT, mdot, list_lb, list_ub)
