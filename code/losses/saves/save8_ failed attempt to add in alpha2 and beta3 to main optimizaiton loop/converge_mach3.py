...
def converge_mach3(one, two, thr, stator, rotor, gamma, cp, R, GR, psi, DeltaH_prod):

    def f_mach3(Mach3, one, two, thr, stator, rotor, gamma, cp, R, GR, psi, DeltaH_prod):
        ...
        solve_angles(one, two, thr, stator, rotor, gamma, cp, R, GR, psi, DeltaH_prod)
    ...
    thr.vel.M  = fsolve(f_mach3,thr.vel.M,args=(one, two, thr, stator, rotor, gamma, cp, R, GR, psi, DeltaH_prod))[0]
