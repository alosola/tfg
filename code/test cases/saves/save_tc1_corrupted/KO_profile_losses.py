...
def profile_losses_alpha_in_0(S_C, alpha_out):
    ...
    x = np.genfromtxt('dataset_YP_fig1_x.csv', delimiter=',')               # import SC vector
    y = np.flip(np.genfromtxt('dataset_YP_fig1_y.csv', delimiter=','))      # import alpha_in vector
    Z = np.flip(np.genfromtxt('dataset_YP_fig1_Zm.csv', delimiter=','), 1)  # import YP mesh
...
def profile_losses_alpha_in_alpha_out(S_C, alpha_out):
    ...
    x = np.genfromtxt('dataset_YP_fig2_x.csv', delimiter=',')               # import SC vector
    y = np.genfromtxt('dataset_YP_fig2_y.csv', delimiter=',')      # import alpha_in vector
    Z = np.flip(np.genfromtxt('dataset_YP_fig2_Zm.csv', delimiter=','), 1)  # import YP mesh
