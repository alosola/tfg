...
thr.P0 = 300000               # outlet static pressure [Pa]
thr.T0 = 1100                  #  # outlet total temperature [K]
DeltaH_prod = 700000           #  # enthalpy produced by turbine [J/Kg]
...
h_c_rotor = 0.7                  # height/chord ratio rotor [-]
t_o = 0.25                        # trailing-egde thickness to throat opening ratio [-]

expected = [etas, 1, 0.611,  6600, 0.065+0.054]
