...
one.P0 = 1852000                  # inlet total pressure (exit combustor) [Pa]
thr.P = 700000                    # outlet static pressure [Pa]
...
print("Stator pressure loss: ", round(stator.omegaKO[0],2))
print("Rotor pressure loss: ", round(rotor.omegaKO[0],2))
...
# graphs.velocity_triangle(two.vel.Vu[0], two.vel.Vx[0], thr.vel.Vu[0], thr.vel.Vx[0], two.vel.Wu[0], two.vel.Wx[0], thr.vel.Wu[0], thr.vel.Wx[0])
